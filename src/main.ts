...
const rooms: Room[] = [
  ...
  new Room({name: "HHBUG01", hasVisualizer: false, hasCeilingMic: false, hasLecternLamp: false, confirmed: true, numberOfWirelessMics: 2 }),
  ...
  new Room({name: "HHBUG06", hasVisualizer: false, hasCeilingMic: false, hasLecternLamp: false, confirmed: true, numberOfWirelessMics: 2 }),
  ...
  new Room({name: "HHBUG13", hasVisualizer: false, hasCeilingMic: true, hasLecternLamp: false, confirmed: true, numberOfWirelessMics: 2 }),
  ...
  new Room({name: "HHB106", hasVisualizer: false, hasCeilingMic: true, hasLecternLamp: false, confirmed: true, numberOfWirelessMics: 2 }),
  new Room({name: "HHB107", hasVisualizer: false, hasCeilingMic: true, hasLecternLamp: false, confirmed: true, numberOfWirelessMics: 2 }),
  new Room({name: "HHB109", hasVisualizer: false, hasCeilingMic: true, hasLecternLamp: false, confirmed: true, numberOfWirelessMics: 2 }),
  new Room({name: "HHB110", hasVisualizer: false, hasCeilingMic: true, hasLecternLamp: false, confirmed: true, numberOfWirelessMics: 2 }),
  new Room({name: "HHB201", hasVisualizer: false, hasCeilingMic: false, hasLecternLamp: false, confirmed: true, numberOfWirelessMics: 2 }),
];
